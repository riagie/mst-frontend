    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          Pilih salah satu opsi di bawah ini untuk mengelola transaksi Anda.
        </p>
      </div>
      <!-- Navigation Buttons -->
      <div class="flex justify-center pt-4 space-x-4">
        <a href="/show-transaksi" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">
          Show Transactions
        </a>
        <a href="/input-transaksi" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700">
          Input Transaction
        </a>
      </div>
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/nuxt/nuxt.js" target="_blank">
          <svg class="w-6 h-6 text-gray-600 hover:text-gray-800" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
            role="img" width="32" height="32" viewBox="0 0 24 24">
            <path
